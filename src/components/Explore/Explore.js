...
const Explore = () => {
    ...
    return (
        <div>
            <h1 className="homeservice-title text-danger mt-5">Our Menu</h1>
            <h4 className="text-success"> Check out the gourmet dishes we have to offer in your event! </h4>
            ...
            <Row sm={1} md={4} className= "g-4 " > 
               {services.slice(20,35).map(service=><HomepageSingleService key={service._id} service={service}></HomepageSingleService>) }
