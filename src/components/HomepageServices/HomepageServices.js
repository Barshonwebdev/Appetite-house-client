...
const HomepageServices = () => {
    ...
    return (
        <div>
            <h1 className="homeservice-title text-danger">Our Best Services</h1>
            ...
            <Row sm={1} md={3} className= "g-4 " > 
               {services.slice(20,23).map(service=><HomepageSingleService key={service._id} service={service}></HomepageSingleService>) }
