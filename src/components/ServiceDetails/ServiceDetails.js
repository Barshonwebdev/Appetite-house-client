...
const ServiceDetails = () => {
    ...
    return (
            ...
            <div className="details-div">
                <h4 className="text-success">Username: {user.displayName}</h4>
                <h4 className="text-success">Email: {user.email}</h4>
                <h2 > <span className="text-danger"> Package Name: </span> {allData?.Name}</h2>
                ...
                <div className="form">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <br/>
                                <input type="submit" className="btn-danger" value="Place Order" />
                    </form>
                </div>
            </div>
